...
training_data = r'F:\Pneumonia_detection\dataset\chest_xray\train'
testing_data = r'F:\Pneumonia_detection\dataset\chest_xray\test' #Give our training and testing path

for each_layer in vgg_model.layers:
    each_layer.trainable = False #Set the trainable as False, So that all the layers would not be trained.
classes = glob(r'F:\Pneumonia_detection\dataset\chest_xray\train\*') #Finding how many classes present in our train dataset.
...
training_set = train_datagen.flow_from_directory(r'F:\Pneumonia_detection\dataset\chest_xray\train', #inserting the images.
                                                 target_size = (224, 224),
                                                 batch_size = 4,
                                                 class_mode = 'categorical')
test_set = testing_datagen.flow_from_directory(r'F:\Pneumonia_detection\dataset\chest_xray\test',
                                               target_size = (224, 224),
                                               batch_size = 4,
                                               class_mode = 'categorical')
...
final_model.save('pneumonia_prediction_model.h5') #Saving the model file.
